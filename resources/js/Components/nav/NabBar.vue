...
const handleDebouncedScroll = _.debounce(handleScroll, 10)
            ...
            <ul class="font-semibold list-none hidden sm:block">
                <Menu v-if="$page.props.auth?.user"
                    ...
                    <MenuButton
                        ...
                        <i class="ri-arrow-down-s-line align-middle -mr-1 ml-2 h-5 w-5" aria-hidden="true"/>
                    </MenuButton>
                            ...
                            <div class="py-1">
                                <MenuItem>
                                    <Link :href="$route('dashboard')"
                                      ...
                                      hover:after:w-6 py-4">العرائض الخاصة بي
                                    </Link>
                                </MenuItem>
                                <MenuItem>
                                    <a href="#"
